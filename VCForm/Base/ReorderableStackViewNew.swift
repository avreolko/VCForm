...
public protocol IReorderableStackViewNewDelegate: AnyObject {
    func swapped(index: Int, with: Int)
}

public class ReorderableStackViewNew: UIStackView {
    ...
    public weak var delegate: IReorderableStackViewNewDelegate?
...
private extension ReorderableStackViewNew {
