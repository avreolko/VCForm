...
//  VCFormExample
//
//  Created by Valentin Cherepyanko on 02.03.2020.
...
@objc
public protocol ReorderableStackViewDelegate {
...
public class ReorderableStackView: UIStackView, UIGestureRecognizerDelegate {
    ...
    public weak var reorderDelegate: ReorderableStackViewDelegate?
    ...
    public var otherViewsScale: CGFloat = 0.9
    public var temporaryViewAlpha: CGFloat = 0.8
    /// The gap created once the long press drag is triggered
    public var dragHintSpacing: CGFloat = 5
    public var longPressMinimumPressDuration = 0.1 {
        didSet {
...
private extension ReorderableStackView {
    ...
    @objc
    private func handleLongPress(_ gr: UILongPressGestureRecognizer) {
    ...
    func styleViewsForReordering() {
        ...
        shadowOpacity.toValue = 0.05
        shadowOpacity.duration = 0.1
